  ...
  return (
    <>
      <SEOHead
        ...
        description="LornuAI is an AI-powered Retrieval-Augmented Generation platform for enterprise knowledge retrieval, content generation, and data analysis using cloud-native AI services."
        canonical="/"
