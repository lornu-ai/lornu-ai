    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          >
            <h1 className="text-4xl lg:text-5xl font-bold mb-4"><GradientText>Terms of Service</GradientText></h1>
              ...
              <CardContent className="pt-6 space-y-8">
                ...
                <section>
                  ...
                  <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                    <li>Amazon Web Services (Bedrock / Sagemaker)</li>
                    <li>Google Vertex AI (Gemini models)</li>
                  </ul>
                  <p className="text-muted-foreground leading-relaxed mt-4">
                    All AI inference requests are routed through secure enterprise gateways for analytics, caching, and optimization.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Content generated by AI models through the Service ("AI Outputs"), including email triage summaries:
                  </p>
                  <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                    <li>You retain ownership of your input prompts and queries</li>
                    <li>AI Outputs, especially Gemini-generated triage summaries, are provided "As-Is" without warranties of accuracy</li>
                    <li>You are responsible for reviewing and verifying the accuracy of AI Outputs before acting on them</li>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    Furthermore, for the Mobile-First (MDX) platform, you are responsible for maintaining accurate "Agent Card"
                    metadata and ensuring correct namespace configuration to prevent unauthorized agent interactions.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    including registered users. The Service is provided through third-party infrastructure (Google Kubernetes Engine, AWS EKS,
                    Google Vertex AI, AWS Bedrock) and may be subject to downtime or performance issues beyond our control.
                  </p>
                </section>
                ...
                <section>
                  <h2 className="text-2xl font-semibold mb-4">12. A2A Protocol Governance</h2>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    The Service utilizes the Agent-to-Agent (A2A) Protocol for autonomous collaboration. You acknowledge that:
                  </p>
                  <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                    <li><strong>Secure & Opaque:</strong> Inter-agent communication is encrypted and opaque to external observers for security.</li>
                    <li><strong>Autonomous Actions:</strong> Agents may perform autonomous actions based on their programming and your high-level directives.</li>
                    <li><strong>Liability:</strong> LornuAI is not liable for unintended side effects resulting from complex multi-agent interactions initiated by your configuration.</li>
                  </ul>
                </section>
