...
resource "aws_cloudwatch_log_group" "waf" {
  name              = "aws-waf-logs-lornu-ai-production"
...
# Global WAF Logging (us-east-1)
resource "aws_cloudwatch_log_group" "waf_global" {
  provider          = aws.us_east_1
  name              = "aws-waf-logs-lornu-ai-global"
  retention_in_days = 30
}
...
resource "aws_wafv2_web_acl_logging_configuration" "cloudfront" {
  ...
  log_destination_configs = [aws_cloudwatch_log_group.waf_global.arn]
}
